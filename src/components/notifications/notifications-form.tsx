...
const mockUsers: User[] = [
  { id: '1', name: 'أحمد حسن', email: 'ahmed@example.com', mobile: '+20 123 456 7890' },
  { id: '2', name: 'فاطمة أحمد', email: 'fatima@example.com', mobile: '+20 111 222 3333' },
  { id: '3', name: 'محمد علي', email: 'mohammed@example.com', mobile: '+20 987 654 3210' },
  { id: '4', name: 'عائشة محمد', email: 'aisha@example.com', mobile: '+20 555 666 7777' },
  { id: '5', name: 'علي أحمد', email: 'ali@example.com', mobile: '+20 444 333 2222' },
];
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='space-y-2'>
              <Label htmlFor='description'>محتوى الإشعار *</Label>
              <Textarea
                id='description'
                value={description}

...
import { Edit, Eye, Trash2, Power, PowerOff, MoreHorizontal, Package, Tag, Building, Users } from 'lucide-react';
              ...
              <TableRow key={product.id}>
                ...
                <TableCell>
                  <Avatar className="h-12 w-12">
                    ...
                    <AvatarFallback>
                      {product.enName.charAt(0).toUpperCase()}
                    </AvatarFallback>
                  </Avatar>
                </TableCell>
                ...
                <TableCell>
                  <Badge 
                    variant={product.gender === 'male' ? 'default' : product.gender === 'female' ? 'secondary' : 'destructive'}
                  >
                    {product.gender}
                  </Badge>
                </TableCell>
                ...
                <TableCell className="text-right">
                  <div className="text-sm">
                    <div className="font-medium">
                      ${getMinPrice(product.variants).toFixed(2)}
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <label className="text-sm font-medium text-muted-foreground">Arabic Description</label>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Badge 
                    variant={selectedProduct.gender === 'male' ? 'default' : selectedProduct.gender === 'female' ? 'secondary' : 'destructive'}
                  >
                    ...
                    <div key={variant.id} className="border rounded-lg p-4 space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-2">
                          ...
                          {variant.todayDeals && (
                            <Badge variant="secondary" className="text-xs">Today Deals</Badge>
                          )}
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <div>
                          <span className="text-muted-foreground">Sale Price:</span> ${variant.salePrice}
                        </div>
                        <div>
                          <span className="text-muted-foreground">Quantity:</span> {variant.currentQty}
                        </div>
                        <div>
      ...
      <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete product <strong>{productToDelete?.enName}</strong>? This
